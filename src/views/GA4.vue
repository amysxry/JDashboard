        ...
        <template v-else>
          <div class="kpi-card">
            <div class="kpi-header">
              ...
              <InfoTooltip text="Personas que interactuaron con tu sitio en el período seleccionado" />
            </div>
          ...
          <div class="kpi-card">
            <div class="kpi-header">
              ...
              <InfoTooltip text="Total de visitas a tu sitio web, incluyendo múltiples visitas del mismo usuario" />
            </div>
          ...
          <div class="kpi-card">
            <div class="kpi-header">
                ...
                <InfoTooltip text="Tiempo promedio que los usuarios pasan en tu sitio por sesión" />
            </div>
